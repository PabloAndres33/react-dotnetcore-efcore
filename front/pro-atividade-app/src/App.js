...
function App() {
  ...
  useEffect(() => {
    const getAtividades = async () => {
      const todasAtividaes = await pegarTodasAtividades();
      if(todasAtividaes) setAtividades(todasAtividaes);
    };
    getAtividades();
  }, []);
  ...
  return (
    <>
      <div className='d-flex justify-content-between align-items-end mt-2 pb-3 border-bottom border-1'>
        <h1 className='m-0 b-0'>Atividade {atividade.id !== 0 ? atividade.id : ''}</h1>
